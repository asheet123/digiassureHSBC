				...
				<div class="marginTop15px"></div>
						<div class="panel panel-info">
							...
							<div class="panel-body">
								...
								<form:form  class="form-horizontal" action="addNewRunCafeSeetest" method="POST" id="addNewRunCafeSeetest"
									...
									<div class="form-group">
										...
										<c:if test="${not empty runName}">
											<input type="text" class="form-control"
												value="${runName }" disabled="disabled" />
									...
									<label class="radio-inline "> 
										<input class="pull-left" name="scheduledStatus" id="scheduledStatus" value="ScheduledAt"
											type="radio"><label for="ScheduledAt"> Schedule At</label>
									</label>
										<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="submit" class="btn btn-success btnCenter" onsubmit="alert()"/>
										</div>
									</div>
								</form:form>
								</c:if>
								...
								<form:form  class="form-horizontal" action="addNewRunCafePerformance" method="POST" id="addNewRunCafePerformance"
									modelAttribute="newRun" title="addNewRunCafePerformance"
									enctype="multipart/form-data">
									<input type="hidden" name="toolName"
										value=${toolName }>
									<div class="form-group">
									...
									<div class="form-group">
											<label for="neoload_config_folder" class="col-sm-3 control-label">Neoload Config zip folder</label>
										<div class="col-sm-3">
											<input type="file" id="configZipFolder"
												name="configZipFolder">
										</div>
									...
									<div class="form-group">
										...
										<label for="master_config" class="col-sm-3 control-label">Neoload Project</label>
										<div class="col-sm-3">
								...
								<form:form  class="form-horizontal" action="addNewRunCucumber" method="POST" id="addNewRunCucumber" 
								...
								<c:if test="${toolName eq 'Appium_Grid' ||toolName eq 'Automated_Accessibility' }">
								<form:form  class="form-horizontal" action="addNewRun" method="POST"
									id="addNewRunAppiumGrid" modelAttribute="newRun"
									...
									<div class="form-group">
										<!-- <label for="zipped_bin_folder" class="col-sm-3 control-label">Zip
											Bin Folder </label> -->
										<label for="zipped_Excel_folder"
											class="col-sm-3 control-label">Upload Configuration </label>
										<div class="col-sm-3">
											<input type="file" id="config_zip"
												name="config_zip">
										</div>
